...
class PickupCard extends StatelessWidget {
  ...
  Widget _buildStatusInfo(PickupModel pickup) {
    switch (pickup.status) {
      ...
      case 'arrived':
        return Row(children: [
          ...
          Text('Collector sudah tiba!',
              style: AppTextStyles.bodySmall.copyWith(color: AppColors.statusArrived, fontWeight: FontWeight.w600)),
        ]);
      case 'completed':
        return Row(children: [
      ...
      default:
        return Text('Mencari collector terdekat...', style: AppTextStyles.bodySmall.copyWith(color: AppColors.textSecondary));
    }
  }
